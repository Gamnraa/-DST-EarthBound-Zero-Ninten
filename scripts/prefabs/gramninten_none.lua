...
table.insert(prefabs, CreatePrefabSkin("ms_gramninten_batter", {
	assets = {
		Asset("ANIM", "anim/ms_gramninten_batter.zip"),
		Asset("ANIM", "anim/ghost_gramninten.zip"),
	},
	
	skins = {
		normal_skin = "ms_gramninten_batter",
		ghost_skin = "ghost_gramninten",
	},
	
	base_prefab = "gramninten",
	build_name_override = "ms_gramninten_batter",
	type = "base",
	rarity = "ModMade",
	skin_tags = {"BASE", "GRAMNINTEN"},
}))

table.insert(prefabs, CreatePrefabSkin("ms_gramninten_kenbatter", {
	assets = {
		Asset("ANIM", "anim/ms_gramninten_kenbatter.zip"),
		Asset("ANIM", "anim/ghost_gramninten.zip"),
	},
	
	skins = {
		normal_skin = "ms_gramninten_kenbatter",
		ghost_skin = "ghost_gramninten",
	},
	
	base_prefab = "gramninten",
	build_name_override = "ms_gramninten_kenbatter",
	type = "base",
	rarity = "ModMade",
	skin_tags = {"BASE", "GRAMNINTEN"},
}))
